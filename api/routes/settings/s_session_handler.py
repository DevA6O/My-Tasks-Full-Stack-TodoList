...
class SettingSessionsHandler:
    ...
    def _is_session_match(self) -> bool:
        ...
        # Check whether the token, which should be revoked, 
        # has no session id or sub
        if not session_id:
        ...
        # Check whether the current token was created by the refresh 
        # token which should be revoked
